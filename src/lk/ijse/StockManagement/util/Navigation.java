package lk.ijse.StockManagement.util;
...
public class Navigation {
    ...
    public static void swatchNavigation(String link, ActionEvent event) throws IOException {
        parent = FXMLLoader.load(Navigation.class.getResource("/lk/ijse/StockManagement/view/" + link));
    ...
    public static void popupNavigation(String link) throws IOException {
        URL resource = Navigation.class.getResource("/lk/ijse/StockManagement/view/" + link);
